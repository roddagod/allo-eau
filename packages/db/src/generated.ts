...
export type Database = {
  ...
  public: {
    Tables: {
      companies: {
        Row: {
          ...
          max_concurrent_orders_per_driver: number
          opening_hours: Json
          operator_type: Database["public"]["Enums"]["company_operator_type"]
          orders_count: number
          phone: string | null
          rccm: string | null
        ...
        Relationships: [
          {
            ...
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "available_companies_by_zone"
          ...
          },
          {
            ...
            columns: ["zone_id"]
            isOneToOne: false
            referencedRelation: "uncovered_zones"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "company_zones_zone_id_fkey"
      ...
      driver_position_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "driver_position_history_driver_id_fkey"
            columns: ["driver_id"]
            isOneToOne: false
      ...
      drivers: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "drivers_current_route_fk"
          ...
          {
            foreignKeyName: "drivers_primary_zone_id_fkey"
      ...
      logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "logs_zone_id_fkey"
            columns: ["zone_id"]
            isOneToOne: false
            referencedRelation: "uncovered_zones"
            referencedColumns: ["id"]
      ...
      orders: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "orders_price_version_id_fkey"
      ...
      price_versions: {
        ...
        Relationships: [
          {
            foreignKeyName: "price_versions_tier_id_fkey"
            columns: ["tier_id"]
            isOneToOne: false
            referencedRelation: "current_prices"
    ...
    Views: {
      available_companies_by_zone: {
        Row: {
          ...
          operator_type:
            | Database["public"]["Enums"]["company_operator_type"]
            | null
      ...
      company_daily_kpi: {
        Row: {
          ...
          in_delivery_orders: number | null
    ...
    Functions: {
      ...
      auth_supervisor_zones: { Args: never; Returns: string[] }
      detect_zone_from_point: { Args: { point: unknown }; Returns: string }
      disablelongtransactions: { Args: never; Returns: string }
      dispatch_order: {
        Args: {
          p_actor?: string
          p_forced_company_id?: string
          p_order_id: string
        }
        Returns: string
      }
      ...
      find_best_company_for_zone: {
        Args: { p_exclude?: string[]; p_zone_id: string }
        Returns: string
      }
    ...
    Enums: {
      company_operator_type: "private" | "military" | "municipal"
      company_status:
        | "pending_validation"
        | "active"
        | "suspended"
        | "rejected"
        | "deactivated"
      dispatch_mode: "manual" | "auto" | "override"
      driver_status: "off_duty" | "available" | "on_delivery" | "suspended"
      location_source: "gps" | "simulated" | "manual"
      notification_type:
        | "order_transmitted"
        | "order_accepted"
        | "order_refused"
      ...
      order_status:
        ...
        | "cancelled"
        | "incident"
      payment_method: "cash" | "airtel_money" | "moov_money" | "clickpay"
      payment_status:
        | "pending"
        | "confirmed"
        | "failed"
      ...
      user_role:
        ...
        | "admin"
        | "super_admin"
      zone_status: "active" | "inactive" | "draft"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
